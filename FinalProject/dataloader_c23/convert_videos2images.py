...
def convert_video2image(
        video_path, image_path, video_types,
    ...
    if video_types == "youtube":
        nb = min(300, num_frames)
    else:
        nb = 60
...
def pre_process_videos(compression="c23"):
    """
        ...
        for t in video_types:
            ...
            for video in video_list:
                if video != "README.md":
                    ...
                    convert_video2image(video_path, image_path, t)
